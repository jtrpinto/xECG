...
File: test_model_ptb.py
- Takes a model trained with train_model_ptb.py and runs it on the test set,
...
MODEL = "models/ptb_2s"    # Weights of the model to be tested (without .pth)
